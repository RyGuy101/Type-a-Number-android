...
package com.blogspot.mathjoy.tanc;
...
public class MainActivity extends BaseGameActivity implements
	...
	boolean verifyPlaceholderIdsReplaced() {
		...
		int res_ids[] = new int[] { R.string.app_id,
				R.string.achievement_arrogant, R.string.achievement_bored,
				R.string.achievement_humble, R.string.achievement_leet,
	...
	public void onEnteredScore(int requestedScore) {
		...
		mWinFragment
				.setExplanation(mHardMode ? getString(R.string.hard_mode_explanation)
	...
	void pushAccomplishments() {
		...
		if (mOutbox.mBoredSteps > 0) {
			Games.Achievements.increment(getApiClient(),
					...
					mOutbox.mBoredSteps);
			Games.Achievements.increment(getApiClient(),
					getString(R.string.achievement_bored), mOutbox.mBoredSteps);
		}
